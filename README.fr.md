...
[🇬🇧 English](README.md) | [🇫🇷 Français](README.fr.md) · [Installation](INSTALL.fr.md) · [Documentation](docs/) · [Disclaimer](DISCLAIMER.fr.md)
...
Voir [docs/architecture.fr.md](docs/architecture.fr.md) pour le détail.
...
Outil pédagogique. **N'utilise pas le mode `live` avec de l'argent que tu n'es pas prêt à perdre.** Le trading de futures avec levier peut vider un compte en quelques minutes. Lis [DISCLAIMER.fr.md](DISCLAIMER.fr.md) avant tout.
