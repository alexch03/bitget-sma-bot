...
**Open-source Bitget USDT-M trading bot. Pluggable strategies, control dashboard, paper / demo / live modes.**
...
[🇫🇷 Français](README.md) · [Installation](INSTALL.md) · [Documentation](docs/) · [Disclaimer](DISCLAIMER.md)
...
Most crypto bots are either paid black boxes or a few-hundred-line scripts impossible to hack on. **bitget-sma-bot** is deliberately small (~2,000 lines of Python), readable in an evening, and meant to be a **solid starting point**:
